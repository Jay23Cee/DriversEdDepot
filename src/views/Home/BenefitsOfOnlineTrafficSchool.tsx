        ...
        <div className="w-full flex flex-col gap-8">
          ...
          <div className="w-full flex flex-col gap-2">
            <p className="text-black-main text-[28px] leading-8 text-center font-semibold font-inter capitalize">
              Online Drivers Education Course On Any Device, Any Time
            </p>
            <p className="text-[16px] font-inter text-center text-[#6c757d]">
              ...
              fingertips, why should Drivers Education be any different? Explore the
              convenience of online Drivers Ed, a flexible and efficient
          ...
          <div className="w-full flex flex-col gap-2">
            <p className="text-black-main text-[28px] leading-8 text-center font-semibold font-inter capitalize">
              What is an Online Drivers Education?
            </p>
            <p className="text-[16px] font-inter text-center text-[#6c757d]">
              Drivers Ed Depot introduces the concept of online Drivers Education: a digital platform 
