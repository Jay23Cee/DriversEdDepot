    ...
    <Wrapper styles="py-10">
      <div className="w-full flex flex-col gap-4 md:gap-6 justify-center items-center">
        ...
        <p className="text-[16px] md:text-left text-center md:text-[18px] font-normal font-inter">
          GoToDrivingSchool has been a trusted provider of driving education since 1999. We offer comprehensive driving school courses, defensive driving, driver improvement, insurance reduction, and mature driver safety courses in over 25 states across the country. Our courses are designed to help you:
        </p>
        {/* ====> attributes */}
